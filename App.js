  ...
  return (
    <NavigationContainer>
      <tabs.Navigator screenOptions={{
        ...
        <tabs.Screen name='Mapa' component={Mapa} options={{tabBarIcon: ({focused}) => <FontAwesome6 name='map' size={20} iconStyle='solid' color={focused ? "#023E8A" : "#ADE8F4"} />}} />
        {/*<tabs.Screen name='Locais' component={Locais} options={{tabBarIcon: ({focused}) => <FontAwesome6 name='map-pin' size={20} iconStyle='solid' color={focused ? "#023E8A" : "#ADE8F4"} />}} />
        ...
        */}<tabs.Screen name='Sobre' component={Sobre} options={{tabBarIcon: ({focused}) => <FontAwesome6 name='circle-info' size={20} iconStyle='solid' color={focused ? "#023E8A" : "#ADE8F4"} />}} />
      </tabs.Navigator>
    </NavigationContainer>
  );
}